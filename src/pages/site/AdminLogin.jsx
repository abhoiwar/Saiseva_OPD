...
export default function AdminLogin() {
  ...
  const LoadSignInAdmin = () => {
      ...
      const CheckAdmin = JSON.parse(localStorage.getItem("isAdminLoggedIn"));
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <nav className="navbar navbar-light">
                ...
                <div className="d-flex">
                  <Link
                    to="../RecLogin"
                    className="mt-4 logincolor  text-decoration-none"
                  >
                    Reception Login
                  </Link>
                  <Link
                    ...
                    <div className="mt-3 is">
                      <div className="mt-4 mx-5 logincolor">
                         <label className="mx-3 text-dark fs-4">
                              <input type="checkbox" className="mt-3 p-2 mx-3" checked={ AdminChecked } onChange={ KeepAdminSignedIn } />
                                  Keep me sign in
                          </label>
                      </div>
                    </div>
