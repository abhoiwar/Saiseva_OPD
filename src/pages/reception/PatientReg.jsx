...
const [anchorEl, setAnchorEl] = React.useState(null);
 ...
 const loadAllPatientsData = () => {
  ...
  const onSubmit = (data) => {
    ...
    if (!isUpdate) {
      Service.savePatients(formData).then((res) => {
      ...
      <div className="main-container ">
        <header className="header">
          ...
          <button
            ...
            <Button
             className="btn backgroundcolor ms-2 me-2 text-white rounded-2"
              aria-controls="simple-menu" style={{textTransform: 'none'}}
              aria-haspopup="true"
              onClick={handleClick}
            >
              Daily Reports
            ...
            <Menu keepMounted anchorEl={anchorEl} onClose={handleClose} open={Boolean(anchorEl)} >
                <MenuItem style={{ backgroundColor : "#412d91"}}  className="text-white" onClick={() => navigate("/DailyReports")}>Daily</MenuItem>
                <MenuItem style={{ backgroundColor : "#412d91"}}  className="text-white" onClick={() => navigate("/DailyReports")}>Monthly</MenuItem>
                <MenuItem style={{ backgroundColor : "#412d91"}}  className="text-white" onClick={() => navigate("/DailyReports")}>Quarterly</MenuItem>
                <MenuItem style={{ backgroundColor : "#412d91"}}  className="text-white" onClick={() => navigate("/DailyReports")}>Yearly</MenuItem>
            </Menu>
           {/*} <button
              type="button"
                          ...
                          <div className="co-6 col-md-6">
                            <input
                              ...
                              {...register("height", {
                                ...
                                // pattern: {
                                //     value: /^[0-9]+$" /,
                                //     message: "Enter Height in Centimeter",
                                // },
                              })}
                            />
                            {errors.height && (
