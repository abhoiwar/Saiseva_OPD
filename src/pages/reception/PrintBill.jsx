          ...
          <div className=" card receipt rounded-0 ">
            ...
            <table style={{ width: "100%" }}>
              ...
              <tr>
                ...
                <td style={{ textAlign: "right" }}>
                <label className="Hospitalname mx-3"><b>Patient Reg No:</b> {printData && printData.pId}</label>
                </td>
              </tr>
              <tr>
                <td style={{ textAlign: "left" }}>
            ...
            <hr></hr>
              ...
              <table style={{ width: "100%" }}>
                <tr>
                  <td style={{ textAlign: "left" }}>
                  <b>
                    <label style={{ marginLeft: "20px" }}>Amount in Word-{ toWords.convert(totalPrice)}</label>
                  </b>
                  </td>
                  <td style={{ textAlign: "right" }}>
                  <label className='ms-3 text-center' style={{ marginLeft: "20px" }}>Grand Total-{totalPrice}</label>
                  </td>
                </tr>
              </table>
            </div>
