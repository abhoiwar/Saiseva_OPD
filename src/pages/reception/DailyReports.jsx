                    ...
                    <div className="row justify-content-end mt-2" >
                        ...
                        <div className=" card receipt rounded-0 ">
                            <table style={{ width: "100%" }}>
                                ...
                                <tr>
                                <td style={{ textAlign: "left" }}>
                                <label className="mx-3">Reg.No.1234</label>
                                </td>
                                <td style={{ textAlign: "right" }}>
                                    <label className="Hospitalname mx-3"> <b>Address-</b>Airport Road, Opposite to</label> <br/>
                           ...
                           <hr/>
                            <table className="table table-bordered table-striped " style={{ width: "100%" }}>
                                <thead class="table-dark">
                                    <tr>
                                        <th scope="col" style={{ width: "5%" ,textAlign: "left" }}>Sr No.</th>
                                        <th scope="col" style={{ width: "15%" ,textAlign: "left" }}>Patient Reg.No.</th>
                                        <th scope="col" style={{ width: "25%" ,textAlign: "left" }}>Patient Name</th>
                                        <th scope="col" style={{ width: "10%" ,textAlign: "left" }}>Treatment</th>
                                        <th scope="col" style={{ width: "15%" ,textAlign: "left" }}>Treatment Date</th>
                                        <th scope="col" style={{ width: "15%" ,textAlign: "right" }}>Bill Amount</th>
                                        <th scope="col" style={{ width: "15%" ,textAlign: "right" }}>SubTotal</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {
                            ...
                            <div className='row '>
                                <div style={{ textAlign: "left" }}>
                                    <b>
                                        <label style={{ marginLeft: "20px" }}>Amount in Word-{ toWords.convert(GrandTotal)} only.</label>
                                    </b>
                                </div>
                                <div style={{ textAlign: "right" }} >
                                    <b>
                                        <label className='ms-3 text-right' style={{ marginLeft: "20px" }}>Grand Total : {GrandTotal}</label>
                                    </b>
                                </div>
                            </div>
                        </div>
